...
<div class="main-panel">
            ...
            <header>
                ...
                <div class="searchbar">
                    ...
                    <div class="topnav" id="myTopnav" style="background-color: #F8F8FF; border: none !important">
                        <ul class="nav nav-tabs" role="tablist" style="border: none !important">

                            <a href="" data-toggle="modal" data-target="#SVModal" class="post-job-btn" style="width: 160px">
                                <i aria-hidden="true" style="background-color: transparent; box-shadow: none; border: none" class="fa fa-plus-square"> </i>
                                                                        ...
                                                                        <table class="table">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>12-05-18</td>
                                                                                    <td class="td-actions">
                                                                                        <i class="fa fa-eye" data-toggle="modal" data-target="#SVModal" style="border: none; box-shadow: none; background: blue; cursor: pointer; color: white"></i>
                                                                                        <i class="fa fa-trash" data-toggle="modal" data-target="#alert" style="border: none; box-shadow: none; background: red; color: white; cursor: pointer">
                                                                                        </i>
                                                                                        <i class="fa fa-plus" data-toggle="modal" data-target="#SVModal" style="border: none; box-shadow: none; background: green; color: white; cursor: pointer"></i>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                    ...
                                                                                    <td class="td-actions">
                                                                                        ...
                                                                                        <i class="fa fa-eye" data-toggle="modal" data-target="#SVModal" style="border: none; box-shadow: none; background: blue; color: white; cursor: pointer"></i>

                                                                                        <i class="fa fa-trash" data-toggle="modal" data-target="#alert" style="border: none; box-shadow: none; background: red; color: white; cursor: pointer"></i>
                                                                                        <i class="fa fa-plus" data-toggle="modal" data-target="#SVModal" style="border: none; box-shadow: none; background: green; color: white; cursor: pointer"></i>
